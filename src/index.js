...
var languageStrings = {
    "en": {
        "translation": {
            ...
            "SKILL_NAME": "My AI Facts",  // OPTIONAL change this to a more descriptive name
            "GET_FACT_MESSAGE": randomPhrase(GET_FACT_MSG_EN),
            "REPROMPT_MESSAGE": "If you want another fact, you can say tell me a fact, or, tell me an AI fact.",
...
var handlers = {
    ...
    'GetYearFact': function(){
      this.emit('GetNewYearFactIntent');
    },
    'GetNewYearFactIntent': function () {
        //TODO your code here
        var factArr = this.t('FACTS');
        var year = this.event.request.intent.slots["FACT_YEAR"].value;
        var randomFact = randomPhrase(factArr) + " " + year;
        // Create speech output
        var speechOutput = this.t("GET_FACT_MESSAGE") + randomFact;
        var repromptMessage = this.t("REPROMPT_MESSAGE");
        this.emit(':askWithCard', speechOutput, repromptMessage, this.t("SKILL_NAME"), randomFact);
